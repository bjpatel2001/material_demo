                    ...
                    <div class="col s12 m6 l4">
                        <div id="profile-card" class="card">
                            <div class="card-image waves-effect waves-block waves-light">
                                <img class="activator" src="{{url('material/images/user-bg.jpg')}}" alt="user background">
                            </div>
                            <div class="card-content">
                                <img src="{{url('material/images/avatar.jpg')}}" alt="" class="circle responsive-img activator card-profile-image">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m12 l4">
                        <div class="blog-card" >
                            <div class="card">
                                <div class="card-image waves-effect waves-block waves-light">
                                    <img src="{{url('material/images/gallary/30.jpg')}}" alt="blog-img">
                                </div>
                        ...
                        <div class="product-card">
                            <div class="card">
                                <div class="card-image waves-effect waves-block waves-light">
                                    ...
                                    <img src="{{url('material/images/gallary/33.jpg')}}" alt="product-img">
                                </div>
                                <ul class="card-action-buttons">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s4 no-padding">
                                            <a href=""></a><img src="{{url('material/images/amazon.jpg')}}" alt="amazon" class="responsive-img">
...
@push('internalJsLoad')
<!-- chartjs -->
<script type="text/javascript" src="{{url('material/js/plugins/chartjs/chart.min.js')}}"></script>

<script type="text/javascript" src="{{url('material/js/plugins/chartjs/chart-script.js')}}"></script>

<!-- sparkline -->
<script type="text/javascript" src="{{url('material/js/plugins/sparkline/jquery.sparkline.min.js')}}"></script>
<script type="text/javascript" src="{{url('material/js/plugins/sparkline/sparkline-script.js')}}"></script>

<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAAZnaZBXLqNBRXjd-82km_NO7GUItyKek"></script>
<!--jvectormap-->
<script type="text/javascript" src="{{url('material/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
<script type="text/javascript" src="{{url('material/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
<script type="text/javascript" src="{{url('material/js/plugins/jvectormap/vectormap-script.js')}}"></script>

<!--google map-->
<script type="text/javascript" src="{{url('material/js/plugins/google-map/google-map-script.js')}}"></script>
